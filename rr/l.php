...
<form method="get" action="">  
  ...
  <tr>
   ...
   <td>
    ...
    <td><input onclick="return window.location.href='<?php echo $baseUrl; ?>rr/l.php'" type="reset" value="Reset"></td>
...
print("<TR><th>Total Time</th><th>CAMP ID</th><TH>Last Visit</TH><th>Behaviour</th><th>Recording</th><th>Keyword/Gclid</th><th>IP Address</th><th>Created</th></TR>\n");
           ...
           // if(filesize($dir_path.$fileName)>5000){
               ...
               //  $totalEvents=isset($arra['events'])?count($arra['events']):"";
                ...
                // print_r($arra['events'][0]['timestamp']);
                 //exit;
                 print("<TR>");   
                 print("<td>");  echo $totalMinutes>0?$totalMinutes:$totalSeconds; echo $totalMinutes>0?"Mins":"Secs"; echo ("</td>");
                 print("<td>");  echo $campaign; print("</td>"); 
                 print("<td>");  echo parse_url($visitUrl, PHP_URL_PATH); echo ("</td>");
                 print("<td>");  
                 echo $isActive=="yes"?"Mouse-Move":"";
                 echo $enterValue=="yes"?"| Enter-Value":"";
                 echo $submitForm=="yes"?"| Submit-Click":"";
            ...
            <a target='_blank' href='$baseUrl/rr/p.php?rec=".$urlRedirect."'>$fileName</a><br>");
             $subFile=array_search($sessionName,$subFiles);
             if($subFile!=""){
              echo "<a target='_blank' href='$baseUrl/rr/p.php?rec=".$subFile."'>$subFile</a>"; 
              echo '<br>';
             }
