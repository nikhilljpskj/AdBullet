$(function() {
  ...
  const handlers = [
    {
      ...
      handler: function handleMouseMove(e) {
        ...
        save_content_to_file(recording);

        console.log('mousemove',recording);
    ...
    },
    {
      ...
      handler: function handleKeyPress(e) {
        ...
        save_content_to_file(recording);
         ...
         console.log('keypress',recording);
      }
    }
  ];
  ...
  //     // stop recording
  //     //beginQuoteFileUnquoteUpload(recording);
  ...
  function save_content_to_file(content)
{
              
        return axios.post("record/data.php", content);
